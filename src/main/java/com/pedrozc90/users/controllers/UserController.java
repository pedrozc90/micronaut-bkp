...
public class UserController {
    ...
    @Get("/")
    public Page<User> fetch(@Nullable @QueryValue(value = "page", defaultValue = "1") final int page,
                            @Nullable @QueryValue(value = "rpp", defaultValue = "15") final int rpp,
                            @Nullable @QueryValue(value = "q") final String q,
                            @Nullable @QueryValue(value = "tenant_id") final Long tenantId) {
        return userRepository.fetch(page, rpp, q, tenantId);
    }
